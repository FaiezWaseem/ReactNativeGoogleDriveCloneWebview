...
function openNav() {
    if(_x == 0){
        document.getElementById("upload").classList.add('show-menu')
        document.getElementById("createfolder").classList.add('show-menu')
        _x=1;
    }else{
        document.getElementById("upload").classList.remove('show-menu')
        document.getElementById("createfolder").classList.remove('show-menu')
        _x = 0
  }
  }
